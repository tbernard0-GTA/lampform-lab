...
for (const [command, args] of [[process.execPath, ['--test', 'tests/data.test.mjs', 'tests/designs.test.mjs', 'tests/experiment.test.mjs', 'tests/catalog-selection.test.mjs', 'tests/experience.test.mjs']],
